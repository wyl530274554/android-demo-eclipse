...
//			return name+"-"+major+"-"+minor+"-"+proximityUuid+"-"+bluetoothAddress+"-"+txPower+"-"+rssi;
			return "iBeacon [name=" + name + ", major=" + major + ", minor=" + minor + ", proximityUuid=" + proximityUuid + ", bluetoothAddress=" + bluetoothAddress + ", txPower="
			+ txPower + ", rssi=" + rssi + "]";
		}
    }
